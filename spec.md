...
#### Purpose
- Simulates a physical rotary / push knob

#### Interaction Model
1. Click (< threshold): visual rotation only
2. Press & Hold (>= threshold): depth press without rotation

#### Rules
- MUST NOT be used as a form input
- No extra animation beyond defined rotation
